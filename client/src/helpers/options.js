...
export const britishCurriculum = [
    { value: 'Pre Nursery', label: 'Pre Nursery' },
    { value: 'Nursery 1', label: 'Nursery 1' },
    { value: 'Nursery 2', label: 'Nursery 2' },
...
export const americanCurriculum = [
...
//Pre-school Subjects
export const preSchoolSubjects = [
    { value: "Literacy", label: "Literacy" },
    { value: "Numeracy", label: "Numeracy" },
    { value: "Phonics", label: "Phonics" },
];

//Elementary Subjects (Nursery 1 & 2)
...
export const primarySubjects = [
    ...
    { value: "Art and Society", label: "Art and Society" },
    { value: "History", label: "History" },
];


//Lower Secondary Subjects
export const lowerSecondarySubjects = [
    { value: "Mathematics", label: "Mathematics" },
    { value: "English", label: "English" },
...
export const upperSecondarySubjects = [
    { value: "Mathematics", label: "Mathematics" },
    { value: "English", label: "English" },
    { value: "Computing", label: "Computing" },
